...
/*[CONSTRUCTOR MARKER END]*/
   ...
   private Set<Exam> collectExams(String condition, Object paramValue) {
      ...
      exams.addAll(StudentDAO.getInstance().getSession().createQuery(
                  "select distinct o.exam from ExamOwner o, StudentClassEnrollment e " +
                        "where e.student.uniqueId=:studentId and o.ownerType=:ownerType " +
                        "and o.ownerId=e.clazz.uniqueId and " + condition, Exam.class)
            .setParameter("studentId", getUniqueId())
            .setParameter("ownerType", ExamOwner.sOwnerTypeClass)
            .setParameter("examType", paramValue)
            .setCacheable(true).list());
      exams.addAll(StudentDAO.getInstance().getSession().createQuery(
                  "select distinct o.exam from ExamOwner o, StudentClassEnrollment e " +
                        "where e.student.uniqueId=:studentId and o.ownerType=:ownerType " +
                        "and o.ownerId=e.clazz.schedulingSubpart.instrOfferingConfig.uniqueId and " + condition, Exam.class)
            .setParameter("studentId", getUniqueId())
      ...
      exams.addAll(StudentDAO.getInstance().getSession().createQuery(
                  "select distinct o.exam from ExamOwner o, StudentClassEnrollment e " +
                        "where e.student.uniqueId=:studentId and o.ownerType=:ownerType " +
                        "and o.ownerId=e.courseOffering.uniqueId and " + condition, Exam.class)
            .setParameter("studentId", getUniqueId())
      ...
      exams.addAll(StudentDAO.getInstance().getSession().createQuery(
                  "select distinct o.exam from ExamOwner o, StudentClassEnrollment e " +
                        "where e.student.uniqueId=:studentId and o.ownerType=:ownerType " +
                        "and o.ownerId=e.courseOffering.instructionalOffering.uniqueId and " + condition, Exam.class)
            .setParameter("studentId", getUniqueId())
   ...
   public Set<Exam> getExams(Integer examType) {
      return collectExams("o.exam.examType.type = :examType", examType);
   }


   public Set<Exam> getExams(ExamType examType) {
      return collectExams("o.exam.examType.uniqueId = :examType", examType.getUniqueId());
   }
